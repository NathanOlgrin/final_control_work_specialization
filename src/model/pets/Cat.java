...
public class Cat implements Serializable, AnimalGenerality<Cat> {
    private int id;
    private String name;
    private String commands;
    private LocalDate birthday;

    public Cat(int id, String name, String songs, LocalDate birthday) {
        id = -1;
        this.name = name;
        this.commands = songs;
    ...
    public Cat(String name, String songs, LocalDate birthday)
    {
