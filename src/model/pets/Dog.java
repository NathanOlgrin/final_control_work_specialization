...
public class Dog implements Serializable, AnimalGenerality<Dog> {
    ...
    public Dog(int id, String name, String songs, LocalDate birthday) {
        id = -1;
        this.name = name;
        this.commands = songs;
    ...
    public Dog(String name, String songs, LocalDate birthday)
    {
